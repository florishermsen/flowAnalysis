...
**************************************************************************/
// AliFlowAnalysisWithMCEventPlane_mod:
...
#define AliFlowAnalysisWithMCEventPlane_mod_cxx
...
using std::endl;
using std::cout;
ClassImp(AliFlowAnalysisWithMCEventPlane_mod)
...
void AliFlowAnalysisWithMCEventPlane_mod::WriteHistograms(TDirectoryFile *outputFileName)
{
...
//-----------------------------------------------------------------------
void AliFlowAnalysisWithMCEventPlane_mod::Init() {
...
void AliFlowAnalysisWithMCEventPlane_mod::Make(AliFlowEventSimple* anEvent) {
...
void AliFlowAnalysisWithMCEventPlane_mod::GetOutputHistograms(TList *outputListHistos) {
...
void AliFlowAnalysisWithMCEventPlane_mod::GetOutputHistoramsForMixedHarmonics(TList *mixedHarmonicsList)
{
...
} // end of void AliFlowAnalysisWithMCEventPlane_mod::GetOutputHistoramsForMixedHarmonics(TList *mixedHarmonicsList)

//--------------------------------------------------------------------    

void AliFlowAnalysisWithMCEventPlane_mod::Finish() {
   
   //*************make histograms etc. 
   if (fDebug) cout<<"AliFlowAnalysisWithMCEventPlane_mod::Terminate()"<<endl;
...
void AliFlowAnalysisWithMCEventPlane_mod::InitalizeArraysForMixedHarmonics()
{
...
void AliFlowAnalysisWithMCEventPlane_mod::BookObjectsForMixedHarmonics()
{
...
} // end of void AliFlowAnalysisWithMCEventPlane_mod::BookObjectsForMixedHarmonics()

//-----------------------------------------------------------------------

void AliFlowAnalysisWithMCEventPlane_mod::EvaluateMixedHarmonics(AliFlowEventSimple* anEvent)
{
...
} // end of void AliFlowAnalysisWithMCEventPlane_mod::EvaluateMixedHarmonics()
